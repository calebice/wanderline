...
export function AppNav() {
  ...
  const current = location.pathname === "/" ? "home" : location.pathname.startsWith("/sessions") ? "sessions" : location.pathname.startsWith("/color-mixing") ? "mixing" : location.pathname.startsWith("/explore") ? "explore" : null;
